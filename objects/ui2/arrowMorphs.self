...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         arrowMorphs = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'arrowMorphs' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'arrowMorphs' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules arrowMorphs.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'arrowMorphs' -> () From: ( | {
         'ModuleInfo: Module: arrowMorphs InitialContents: FollowSlot\x7fVisibility: public'
...
\"high\" is visually on top (in front), \"low\" is visually on bottom (in rear)\x7fModuleInfo: Module: arrowMorphs InitialContents: FollowSlot\x7fVisibility: private'
 ...
 globals loadedModules arrowMorphs postFileIn

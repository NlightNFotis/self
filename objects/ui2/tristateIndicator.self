...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         tristateIndicator = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'tristateIndicator' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'tristateIndicator' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules tristateIndicator.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'tristateIndicator' -> () From: ( | {
...
'.
 ...
 globals loadedModules tristateIndicator postFileIn

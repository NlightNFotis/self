...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         colorWorld = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'colorWorld' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'colorWorld' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules colorWorld.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'colorWorld' -> () From: ( | {
         'ModuleInfo: Module: colorWorld InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules colorWorld postFileIn

...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         testMorphs = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'testMorphs' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'testMorphs' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules testMorphs.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'testMorphs' -> () From: ( | {
         'ModuleInfo: Module: testMorphs InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules testMorphs postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         userQueryMorph = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'userQueryMorph' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'userQueryMorph' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules userQueryMorph.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'userQueryMorph' -> () From: ( | {
...
me to avoid typing in a long number. -- dmu 5/02\x7fModuleInfo: Module: userQueryMorph InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules userQueryMorph postFileIn

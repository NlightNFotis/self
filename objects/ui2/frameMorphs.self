...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         frameMorphs = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'frameMorphs' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'frameMorphs' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules frameMorphs.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'frameMorphs' -> () From: ( | {
         'ModuleInfo: Module: frameMorphs InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules frameMorphs postFileIn

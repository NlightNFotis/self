...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         ui2test = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'ui2test' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'ui2test' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules ui2test.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'ui2test' -> () From: ( | {
...
'.
 ...
 globals loadedModules ui2test postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         qUI2Events = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'qUI2Events' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'qUI2Events' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules qUI2Events.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'qUI2Events' -> () From: ( | {
...
maps them to native Mac methods.\x7fModuleInfo: Module: qUI2Events InitialContents: FollowSlot'
 ...
 globals loadedModules qUI2Events postFileIn

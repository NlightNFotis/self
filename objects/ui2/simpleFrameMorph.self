...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         simpleFrameMorph = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'simpleFrameMorph' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'simpleFrameMorph' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules simpleFrameMorph.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'simpleFrameMorph' -> () From: ( | {
...
'.
 ...
 globals loadedModules simpleFrameMorph postFileIn

...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         carpetMorph = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'carpetMorph' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'carpetMorph' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules carpetMorph.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'carpetMorph' -> () From: ( | {
         'ModuleInfo: Module: carpetMorph InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules carpetMorph postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         snapshotOptionsMorph = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'snapshotOptionsMorph' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'snapshotOptionsMorph' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules snapshotOptionsMorph.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'snapshotOptionsMorph' -> () From: ( | {
...
\x7fIsComplete: '.
 ...
 globals loadedModules snapshotOptionsMorph postFileIn

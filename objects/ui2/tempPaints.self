...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         tempPaints = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'tempPaints' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'tempPaints' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules tempPaints.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'tempPaints' -> () From: ( | {
 ...
 globals loadedModules tempPaints postFileIn

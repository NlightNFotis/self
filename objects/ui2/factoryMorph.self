...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         factoryMorph = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'factoryMorph' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'factoryMorph' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules factoryMorph.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'factoryMorph' -> () From: ( | {
...
Otherwise it just picks the entire morph up.\x7fModuleInfo: Module: factoryMorph InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules factoryMorph postFileIn

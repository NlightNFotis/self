...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         capability = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'capability' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'capability' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules capability.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'capability' -> () From: ( | {
         'ModuleInfo: Module: capability InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules capability postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         trashCanMorph = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'trashCanMorph' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'trashCanMorph' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules trashCanMorph.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'trashCanMorph' -> () From: ( | {
...
'.
 ...
 globals loadedModules trashCanMorph postFileIn

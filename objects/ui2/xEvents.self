...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         xEvents = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'xEvents' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'xEvents' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules xEvents.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'xEvents' -> () From: ( | {
...
'.
 ...
 globals loadedModules xEvents postFileIn

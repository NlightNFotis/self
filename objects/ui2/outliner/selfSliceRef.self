...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         selfSliceRef = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfSliceRef' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfSliceRef' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules selfSliceRef.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfSliceRef' -> () From: ( | {
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> () From: ( | {
         'Category: graphical interface\x7fCategory: ui2\x7fCategory: Programming Environment\x7fCategory: Pluggable Self Object Outliner\x7fCategory: SliceOutliner & helpers\x7fModuleInfo: Module: selfSliceRef InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules selfSliceRef postFileIn

...
WHen simply yanking an outliner, it is false. -- dmu 5/1\x7fModuleInfo: Module: generalModel InitialContents: InitializeToExpression: (false)\x7fVisibility: public'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         generalModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'generalModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'generalModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules generalModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'generalModel' -> () From: ( | {
         'ModuleInfo: Module: generalModel InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules generalModel postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         allSelfObjOutliner = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'allSelfObjOutliner' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'allSelfObjOutliner' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules allSelfObjOutliner.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'allSelfObjOutliner' -> () From: ( | {
...
-- Ungar, 2/2/95\x7fModuleInfo: Module: allSelfObjOutliner InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules allSelfObjOutliner postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         powerOperations = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'powerOperations' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'powerOperations' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules powerOperations.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'powerOperations' -> () From: ( | {
...
'.
 ...
 globals loadedModules powerOperations postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         profileSliceRef = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSliceRef' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSliceRef' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules profileSliceRef.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSliceRef' -> () From: ( | {
...
'.
 ...
 globals loadedModules profileSliceRef postFileIn

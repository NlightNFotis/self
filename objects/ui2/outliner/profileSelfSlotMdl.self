...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         profileSelfSlotMdl = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSelfSlotMdl' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSelfSlotMdl' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules profileSelfSlotMdl.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSelfSlotMdl' -> () From: ( | {
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> () From: ( | {
         'Category: graphical interface\x7fCategory: ui2\x7fCategory: Programming Environment\x7fCategory: Pluggable Self Object Outliner\x7fCategory: Profile Slice Outliner & helpers\x7fModuleInfo: Module: profileSelfSlotMdl InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules profileSelfSlotMdl postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         selfPCatModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfPCatModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfPCatModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules selfPCatModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfPCatModel' -> () From: ( | {
...
'.
 ...
 globals loadedModules selfPCatModel postFileIn

...
Perform a doIt on this method.\x7fModuleInfo: Module: complexButtonMorph InitialContents: FollowSlot\x7fVisibility: public'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         complexButtonMorph = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'complexButtonMorph' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'complexButtonMorph' -> () From: ( |
             {} = 'Comment: the prototype module object, I am created by init.self.\x7fModuleInfo: Creator: globals loadedModules complexButtonMorph.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'complexButtonMorph' -> () From: ( | {
         'ModuleInfo: Module: complexButtonMorph InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules complexButtonMorph postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         moduleModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'moduleModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'moduleModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules moduleModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'moduleModel' -> () From: ( | {
...
'.
 ...
 globals loadedModules moduleModel postFileIn

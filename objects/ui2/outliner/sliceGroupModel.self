...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         sliceGroupModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sliceGroupModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sliceGroupModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules sliceGroupModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sliceGroupModel' -> () From: ( | {
 ...
 globals loadedModules sliceGroupModel postFileIn

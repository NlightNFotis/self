...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         allModulesModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'allModulesModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'allModulesModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules allModulesModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'allModulesModel' -> () From: ( | {
 ...
 globals loadedModules allModulesModel postFileIn

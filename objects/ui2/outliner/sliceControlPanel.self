...
use this set to stop.\x7fModuleInfo: Module: sliceControlPanel InitialContents: InitializeToExpression: (set copyRemoveAll)\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         sliceControlPanel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sliceControlPanel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sliceControlPanel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules sliceControlPanel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sliceControlPanel' -> () From: ( | {
...
references the objectName, etc.\x7fModuleInfo: Module: sliceControlPanel InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules sliceControlPanel postFileIn

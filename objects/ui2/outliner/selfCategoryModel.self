...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         selfCategoryModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfCategoryModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfCategoryModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules selfCategoryModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfCategoryModel' -> () From: ( | {
...
'.
 ...
 globals loadedModules selfCategoryModel postFileIn

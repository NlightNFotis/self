...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         syntaxErrorMorph = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'syntaxErrorMorph' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'syntaxErrorMorph' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules syntaxErrorMorph.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'syntaxErrorMorph' -> () From: ( | {
...
'.
 ...
 globals loadedModules syntaxErrorMorph postFileIn

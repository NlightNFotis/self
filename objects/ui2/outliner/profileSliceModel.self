...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         profileSliceModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSliceModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSliceModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules profileSliceModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSliceModel' -> () From: ( | {
...
'.
 ...
 globals loadedModules profileSliceModel postFileIn

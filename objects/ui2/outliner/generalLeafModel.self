...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         generalLeafModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'generalLeafModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'generalLeafModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules generalLeafModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'generalLeafModel' -> () From: ( | {
...
'.
 ...
 globals loadedModules generalLeafModel postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         selfSlotModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfSlotModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfSlotModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules selfSlotModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfSlotModel' -> () From: ( | {
...
'.
 ...
 globals loadedModules selfSlotModel postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         profileSlicer = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSlicer' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSlicer' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules profileSlicer.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSlicer' -> () From: ( | {
...
'.
 ...
 globals loadedModules profileSlicer postFileIn

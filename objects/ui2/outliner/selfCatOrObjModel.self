...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         selfCatOrObjModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfCatOrObjModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfCatOrObjModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules selfCatOrObjModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfCatOrObjModel' -> () From: ( | {
...
'.
 ...
 globals loadedModules selfCatOrObjModel postFileIn

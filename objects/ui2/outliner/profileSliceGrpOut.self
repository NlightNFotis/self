...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         profileSliceGrpOut = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSliceGrpOut' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSliceGrpOut' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules profileSliceGrpOut.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'profileSliceGrpOut' -> () From: ( | {
...
'.
 ...
 globals loadedModules profileSliceGrpOut postFileIn

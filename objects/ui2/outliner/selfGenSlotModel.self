...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         selfGenSlotModel = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfGenSlotModel' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfGenSlotModel' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules selfGenSlotModel.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfGenSlotModel' -> () From: ( | {
...
\x7fIsComplete: '.
 ...
 globals loadedModules selfGenSlotModel postFileIn

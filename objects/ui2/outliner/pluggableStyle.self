...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         pluggableStyle = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pluggableStyle' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pluggableStyle' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules pluggableStyle.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pluggableStyle' -> () From: ( | {
         'ModuleInfo: Module: pluggableStyle InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules pluggableStyle postFileIn

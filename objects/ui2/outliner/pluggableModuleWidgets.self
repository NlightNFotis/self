...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         pluggableModuleWidgets = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pluggableModuleWidgets' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pluggableModuleWidgets' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules pluggableModuleWidgets.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pluggableModuleWidgets' -> () From: ( | {
...
'.
 ...
 globals loadedModules pluggableModuleWidgets postFileIn

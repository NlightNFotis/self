...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         selfModuleSetter = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfModuleSetter' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfModuleSetter' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules selfModuleSetter.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selfModuleSetter' -> () From: ( | {
...
-- dmu\x7fModuleInfo: Module: selfModuleSetter InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules selfModuleSetter postFileIn

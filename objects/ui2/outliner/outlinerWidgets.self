...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         outlinerWidgets = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'outlinerWidgets' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'outlinerWidgets' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules outlinerWidgets.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'outlinerWidgets' -> () From: ( | {
         'ModuleInfo: Module: outlinerWidgets InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules outlinerWidgets postFileIn

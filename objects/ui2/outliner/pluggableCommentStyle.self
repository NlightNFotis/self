...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         pluggableCommentStyle = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pluggableCommentStyle' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pluggableCommentStyle' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules pluggableCommentStyle.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pluggableCommentStyle' -> () From: ( | {
 ...
 globals loadedModules pluggableCommentStyle postFileIn

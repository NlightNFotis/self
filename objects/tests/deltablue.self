...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         deltablue = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'deltablue' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'deltablue' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules deltablue.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'deltablue' -> () From: ( | {
         'ModuleInfo: Module: deltablue InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules deltablue postFileIn

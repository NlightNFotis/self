...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         lowLevelTests = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'lowLevelTests' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'lowLevelTests' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules lowLevelTests.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'lowLevelTests' -> () From: ( | {
...
'.
 ...
 globals loadedModules lowLevelTests postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         sicTests = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sicTests' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sicTests' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules sicTests.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sicTests' -> () From: ( | {
...
method performs a sanity check on an error message argument.\x7fModuleInfo: Module: sicTests InitialContents: FollowSlot\x7fVisibility: private'
 ...
 globals loadedModules sicTests postFileIn

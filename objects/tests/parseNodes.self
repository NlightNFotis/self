...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         parseNodes = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'parseNodes' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'parseNodes' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules parseNodes.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'parseNodes' -> () From: ( | {
...
'.
 ...
 globals loadedModules parseNodes postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         languageTests = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'languageTests' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'languageTests' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules languageTests.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'languageTests' -> () From: ( | {
...
'.
 ...
 globals loadedModules languageTests postFileIn

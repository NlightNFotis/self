...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         programmingTests = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'programmingTests' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'programmingTests' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules programmingTests.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'programmingTests' -> () From: ( | {
...
.
 ...
 globals loadedModules programmingTests postFileIn

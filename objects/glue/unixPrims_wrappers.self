...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         unixPrims_wrappers = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'unixPrims_wrappers' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'unixPrims_wrappers' -> () From: ( |
             {} = 'Comment: This information was generated by the primitive maker (primitiveMaker.self).
Please do not change it manually. -- dmu 12/91 \x7fModuleInfo: Creator: globals loadedModules unixPrims_wrappers.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'unixPrims_wrappers' -> () From: ( | {
         'Category: generated by primitiveMaker\x7fModuleInfo: Module: unixPrims_wrappers InitialContents: FollowSlot\x7fVisibility: public'
...
Please do not change it manually. -- dmu 12/91 .'.
 ...
 globals loadedModules unixPrims_wrappers postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         movingShape = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'movingShape' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'movingShape' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules movingShape.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'movingShape' -> () From: ( | {
...
'.
 ...
 globals loadedModules movingShape postFileIn

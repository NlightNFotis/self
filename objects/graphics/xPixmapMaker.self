...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         xPixmapMaker = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'xPixmapMaker' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'xPixmapMaker' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules xPixmapMaker.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'xPixmapMaker' -> () From: ( | {
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> () From: ( | {
         'Category: graphical interface\x7fCategory: graphics\x7fModuleInfo: Module: xPixmapMaker InitialContents: FollowSlot'
...
'.
 ...
 globals loadedModules xPixmapMaker postFileIn

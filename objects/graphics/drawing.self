...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         drawing = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'drawing' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'drawing' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules drawing.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'drawing' -> () From: ( | {
...
'.
 ...
 globals loadedModules drawing postFileIn

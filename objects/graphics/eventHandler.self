...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         eventHandler = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'eventHandler' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'eventHandler' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules eventHandler.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'eventHandler' -> () From: ( | {
...
.
 ...
 globals loadedModules eventHandler postFileIn

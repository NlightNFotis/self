...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         spline = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'spline' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'spline' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules spline.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'spline' -> () From: ( | {
         'ModuleInfo: Module: spline InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules spline postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         windoid = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'windoid' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'windoid' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules windoid.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'windoid' -> () From: ( | {
...
'.
 ...
 globals loadedModules windoid postFileIn

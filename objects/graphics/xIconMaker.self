...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         xIconMaker = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'xIconMaker' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'xIconMaker' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules xIconMaker.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'xIconMaker' -> () From: ( | {
...
,'.
 ...
 globals loadedModules xIconMaker postFileIn

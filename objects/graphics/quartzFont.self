...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         quartzFont = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'quartzFont' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'quartzFont' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules quartzFont.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'quartzFont' -> () From: ( | {
...
\x7fIsComplete: '.
 ...
 globals loadedModules quartzFont postFileIn

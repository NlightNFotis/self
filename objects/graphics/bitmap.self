...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         bitmap = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bitmap' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bitmap' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules bitmap.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bitmap' -> () From: ( | {
         'ModuleInfo: Module: bitmap InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules bitmap postFileIn

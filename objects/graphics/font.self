...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         font = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'font' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'font' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules font.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'font' -> () From: ( | {
 ...
 globals loadedModules font postFileIn

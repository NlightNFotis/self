...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         cgDirectDisplay = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'cgDirectDisplay' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'cgDirectDisplay' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules cgDirectDisplay.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'cgDirectDisplay' -> () From: ( | {
...
'.
 ...
 globals loadedModules cgDirectDisplay postFileIn

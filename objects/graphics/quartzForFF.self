...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         quartzForFF = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'quartzForFF' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'quartzForFF' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules quartzForFF.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'quartzForFF' -> () From: ( | {
...
'.
 ...
 globals loadedModules quartzForFF postFileIn

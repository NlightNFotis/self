...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         cursor = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'cursor' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'cursor' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules cursor.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'cursor' -> () From: ( | {
         'ModuleInfo: Module: cursor InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules cursor postFileIn

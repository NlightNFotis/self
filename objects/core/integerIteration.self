...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         integerIteration = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'integerIteration' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'integerIteration' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules integerIteration.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'integerIteration' -> () From: ( | {
...
the result.\x7fModuleInfo: Module: integerIteration InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules integerIteration postFileIn

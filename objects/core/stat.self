...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         stat = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'stat' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'stat' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules stat.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'stat' -> () From: ( | {
...
'.
 ...
 globals loadedModules stat postFileIn

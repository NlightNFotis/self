...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         oldStyleRectangle = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'oldStyleRectangle' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'oldStyleRectangle' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules oldStyleRectangle.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'oldStyleRectangle' -> () From: ( | {
...
'.
 ...
 globals loadedModules oldStyleRectangle postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         sortedSequence = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sortedSequence' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sortedSequence' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules sortedSequence.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sortedSequence' -> () From: ( | {
...
'.
 ...
 globals loadedModules sortedSequence postFileIn

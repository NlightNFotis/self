...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         random = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'random' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'random' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules random.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'random' -> () From: ( | {
...
\x7fIsComplete: '.
 ...
 globals loadedModules random postFileIn

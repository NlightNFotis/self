...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         tty = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'tty' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'tty' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules tty.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'tty' -> () From: ( | {
...
'.
 ...
 globals loadedModules tty postFileIn

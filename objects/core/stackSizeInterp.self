...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         stackSizeInterp = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'stackSizeInterp' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'stackSizeInterp' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules stackSizeInterp.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'stackSizeInterp' -> () From: ( | {
...
'.
 ...
 globals loadedModules stackSizeInterp postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         selectionText = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selectionText' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selectionText' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules selectionText.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'selectionText' -> () From: ( | {
...
'.
 ...
 globals loadedModules selectionText postFileIn

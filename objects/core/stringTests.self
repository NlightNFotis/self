...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         stringTests = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'stringTests' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'stringTests' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules stringTests.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'stringTests' -> () From: ( | {
...
'.
 ...
 globals loadedModules stringTests postFileIn

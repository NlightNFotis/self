...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         bootstrapFile = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bootstrapFile' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bootstrapFile' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules bootstrapFile.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bootstrapFile' -> () From: ( | {
...
'.
 ...
 globals loadedModules bootstrapFile postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         smallIntTests = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'smallIntTests' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'smallIntTests' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules smallIntTests.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'smallIntTests' -> () From: ( | {
...
'.
 ...
 globals loadedModules smallIntTests postFileIn

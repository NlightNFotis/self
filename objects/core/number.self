...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         number = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'number' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'number' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules number.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'number' -> () From: ( | {
...
a positive result (for a positive divisor).\x7fModuleInfo: Module: number InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules number postFileIn

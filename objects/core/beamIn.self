...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         beamIn = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'beamIn' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'beamIn' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules beamIn.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'beamIn' -> () From: ( | {
...
'.
 ...
 globals loadedModules beamIn postFileIn

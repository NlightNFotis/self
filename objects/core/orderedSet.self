...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         orderedSet = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'orderedSet' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'orderedSet' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules orderedSet.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'orderedSet' -> () From: ( | {
...
'.
 ...
 globals loadedModules orderedSet postFileIn

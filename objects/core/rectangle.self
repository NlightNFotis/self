...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         rectangle = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'rectangle' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'rectangle' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules rectangle.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'rectangle' -> () From: ( | {
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> () From: ( | {
         'Category: graphical interface\x7fCategory: graphics\x7fModuleInfo: Module: rectangle InitialContents: FollowSlot\x7fVisibility: public'
...
-- Ungar, 6/19/95\x7fModuleInfo: Module: rectangle InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules rectangle postFileIn

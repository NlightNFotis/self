...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         branchTargetFinder = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'branchTargetFinder' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'branchTargetFinder' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules branchTargetFinder.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'branchTargetFinder' -> () From: ( | {
 ...
 globals loadedModules branchTargetFinder postFileIn

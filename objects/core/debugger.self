...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         debugger = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'debugger' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'debugger' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules debugger.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'debugger' -> () From: ( | {
         'ModuleInfo: Module: debugger InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules debugger postFileIn

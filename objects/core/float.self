...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         float = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'float' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'float' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules float.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'float' -> () From: ( | {
...
'.
 ...
 globals loadedModules float postFileIn

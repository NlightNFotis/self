...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         bytecodeFormat = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bytecodeFormat' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bytecodeFormat' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules bytecodeFormat.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bytecodeFormat' -> () From: ( | {
         'ModuleInfo: Module: bytecodeFormat InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules bytecodeFormat postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         pair = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pair' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pair' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules pair.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'pair' -> () From: ( | {
...
'.
 ...
 globals loadedModules pair postFileIn

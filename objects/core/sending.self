...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         sending = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sending' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sending' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules sending.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sending' -> () From: ( | {
...
'.
 ...
 globals loadedModules sending postFileIn

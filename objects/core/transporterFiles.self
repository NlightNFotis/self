...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         transporterFiles = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'transporterFiles' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'transporterFiles' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules transporterFiles.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'transporterFiles' -> () From: ( | {
...
'.
 ...
 globals loadedModules transporterFiles postFileIn

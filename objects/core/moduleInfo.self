...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         moduleInfo = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'moduleInfo' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'moduleInfo' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules moduleInfo.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'moduleInfo' -> () From: ( | {
...
'.
 ...
 globals loadedModules moduleInfo postFileIn

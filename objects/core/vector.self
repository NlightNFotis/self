...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         vector = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'vector' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'vector' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules vector.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'vector' -> () From: ( | {
...
literal vector is a part of; for other vectors this fails.\x7fModuleInfo: Module: vector InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules vector postFileIn

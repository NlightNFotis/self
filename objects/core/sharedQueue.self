...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         sharedQueue = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sharedQueue' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sharedQueue' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules sharedQueue.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sharedQueue' -> () From: ( | {
...
-- dmu\x7fModuleInfo: Module: sharedQueue InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules sharedQueue postFileIn

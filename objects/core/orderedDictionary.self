...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         orderedDictionary = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'orderedDictionary' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'orderedDictionary' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules orderedDictionary.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'orderedDictionary' -> () From: ( | {
...
Return the removed element (not the key).\x7fModuleInfo: Module: orderedDictionary InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules orderedDictionary postFileIn

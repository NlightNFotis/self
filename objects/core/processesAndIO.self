...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         processesAndIO = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'processesAndIO' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'processesAndIO' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules processesAndIO.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'processesAndIO' -> () From: ( | {
...
'.
 ...
 globals loadedModules processesAndIO postFileIn

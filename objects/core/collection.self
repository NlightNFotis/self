...
-- dmu\x7fModuleInfo: Module: collection InitialContents: FollowSlot\x7fVisibility: private'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         collection = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'collection' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'collection' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules collection.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'collection' -> () From: ( | {
...
Otherwise, raise an error.\x7fModuleInfo: Module: collection InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules collection postFileIn

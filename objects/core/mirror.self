...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         mirror = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'mirror' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'mirror' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules mirror.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'mirror' -> () From: ( | {
...
(Not sure if end is inclusive. -- dmu 11/04)\x7fModuleInfo: Module: mirror InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules mirror postFileIn

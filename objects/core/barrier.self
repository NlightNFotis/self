...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         barrier = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'barrier' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'barrier' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules barrier.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'barrier' -> () From: ( | {
 ...
 globals loadedModules barrier postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         chain = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'chain' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'chain' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules chain.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'chain' -> () From: ( | {
...
'.
 ...
 globals loadedModules chain postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         slot = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'slot' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'slot' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules slot.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'slot' -> () From: ( | {
...
found in the object \'visibility\'.\x7fModuleInfo: Module: slot InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules slot postFileIn

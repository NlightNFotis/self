...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         block = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'block' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'block' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules block.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'block' -> () From: ( | {
...
'.
 ...
 globals loadedModules block postFileIn

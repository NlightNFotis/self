...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         scheduler = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'scheduler' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'scheduler' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules scheduler.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'scheduler' -> () From: ( | {
...
'.
 ...
 globals loadedModules scheduler postFileIn

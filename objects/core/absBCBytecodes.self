...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         absBCBytecodes = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'absBCBytecodes' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'absBCBytecodes' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules absBCBytecodes.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'absBCBytecodes' -> () From: ( | {
         'ModuleInfo: Module: absBCBytecodes InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules absBCBytecodes postFileIn

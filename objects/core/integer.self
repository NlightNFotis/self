...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         integer = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'integer' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'integer' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules integer.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'integer' -> () From: ( | {
...
'.
 ...
 globals loadedModules integer postFileIn

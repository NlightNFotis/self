...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         primitives = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'primitives' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'primitives' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules primitives.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'primitives' -> () From: ( | {
...
'.
 ...
 globals loadedModules primitives postFileIn

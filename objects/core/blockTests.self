...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         blockTests = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'blockTests' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'blockTests' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules blockTests.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'blockTests' -> () From: ( | {
...
\x7fIsComplete: '.
 ...
 globals loadedModules blockTests postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         ping = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'ping' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'ping' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules ping.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'ping' -> () From: ( | {
...
'.
 ...
 globals loadedModules ping postFileIn

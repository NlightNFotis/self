...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         visibility = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'visibility' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'visibility' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules visibility.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'visibility' -> () From: ( | {
         'ModuleInfo: Module: visibility InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules visibility postFileIn

...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         hosts = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'hosts' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'hosts' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules hosts.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'hosts' -> () From: ( | {
         'ModuleInfo: Module: hosts InitialContents: FollowSlot\x7fVisibility: public'
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'hosts' -> () From: ( | {
         'ModuleInfo: Module: hosts InitialContents: InitializeToExpression: (\'30.16.0\')\x7fVisibility: public'
...
'.
 ...
 globals loadedModules hosts postFileIn

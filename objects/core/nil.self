...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         nil = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'nil' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'nil' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules nil.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'nil' -> () From: ( | {
 ...
 globals loadedModules nil postFileIn

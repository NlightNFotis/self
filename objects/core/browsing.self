...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         browsing = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'browsing' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'browsing' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules browsing.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'browsing' -> () From: ( | {
         'ModuleInfo: Module: browsing InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules browsing postFileIn

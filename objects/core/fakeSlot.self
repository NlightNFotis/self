...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         fakeSlot = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'fakeSlot' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'fakeSlot' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules fakeSlot.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'fakeSlot' -> () From: ( | {
         'ModuleInfo: Module: fakeSlot InitialContents: FollowSlot\x7fVisibility: public'
...
.
 ...
 globals loadedModules fakeSlot postFileIn

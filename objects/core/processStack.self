...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         processStack = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'processStack' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'processStack' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules processStack.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'processStack' -> () From: ( | {
...
'.
 ...
 globals loadedModules processStack postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         bufferedBootstrapFile = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bufferedBootstrapFile' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bufferedBootstrapFile' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules bufferedBootstrapFile.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'bufferedBootstrapFile' -> () From: ( | {
...
'.
 ...
 globals loadedModules bufferedBootstrapFile postFileIn

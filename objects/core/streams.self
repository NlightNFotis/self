...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         streams = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'streams' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'streams' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules streams.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'streams' -> () From: ( | {
...
'.
 ...
 globals loadedModules streams postFileIn

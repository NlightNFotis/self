...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         interceptor = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'interceptor' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'interceptor' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules interceptor.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'interceptor' -> () From: ( | {
         'ModuleInfo: Module: interceptor InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules interceptor postFileIn

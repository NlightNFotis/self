...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         sharedSetAndDictionary = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sharedSetAndDictionary' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sharedSetAndDictionary' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules sharedSetAndDictionary.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'sharedSetAndDictionary' -> () From: ( | {
...
\x7fIsComplete: '.
 ...
 globals loadedModules sharedSetAndDictionary postFileIn

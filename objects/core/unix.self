...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         unix = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'unix' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'unix' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules unix.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'unix' -> () From: ( | {
...
-- Ungar, 2/20/95\x7fModuleInfo: Module: unix InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules unix postFileIn

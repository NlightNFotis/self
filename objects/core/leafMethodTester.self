...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         leafMethodTester = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'leafMethodTester' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'leafMethodTester' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules leafMethodTester.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'leafMethodTester' -> () From: ( | {
 ...
 globals loadedModules leafMethodTester postFileIn

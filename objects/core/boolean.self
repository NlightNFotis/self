...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         boolean = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'boolean' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'boolean' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules boolean.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'boolean' -> () From: ( | {
         'ModuleInfo: Module: boolean InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules boolean postFileIn

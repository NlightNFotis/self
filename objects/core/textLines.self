...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         textLines = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'textLines' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'textLines' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules textLines.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'textLines' -> () From: ( | {
...
'.
 ...
 globals loadedModules textLines postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         unix_stdin = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'unix_stdin' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'unix_stdin' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules unix_stdin.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'unix_stdin' -> () From: ( | {
...
\x7fIsComplete: '.
 ...
 globals loadedModules unix_stdin postFileIn

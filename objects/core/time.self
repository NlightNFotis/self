...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         time = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'time' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'time' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules time.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'time' -> () From: ( | {
...
'.
 ...
 globals loadedModules time postFileIn

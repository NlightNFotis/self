...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         beamOut = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'beamOut' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'beamOut' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules beamOut.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'beamOut' -> () From: ( | {
...
'.
 ...
 globals loadedModules beamOut postFileIn

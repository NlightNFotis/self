...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         semaphore = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'semaphore' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'semaphore' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules semaphore.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'semaphore' -> () From: ( | {
...
otherwise.\x7fModuleInfo: Module: semaphore InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules semaphore postFileIn

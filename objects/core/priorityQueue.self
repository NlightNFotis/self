...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         priorityQueue = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'priorityQueue' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'priorityQueue' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules priorityQueue.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'priorityQueue' -> () From: ( | {
...
priority than the second and false otherwise.\x7fModuleInfo: Module: priorityQueue InitialContents: FollowSlot\x7fVisibility: public'
 ...
 globals loadedModules priorityQueue postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         universalSetAndDictionary = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'universalSetAndDictionary' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'universalSetAndDictionary' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules universalSetAndDictionary.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'universalSetAndDictionary' -> () From: ( | {
...
'.
 ...
 globals loadedModules universalSetAndDictionary postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         point = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'point' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'point' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules point.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'point' -> () From: ( | {
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> () From: ( | {
         'Category: graphical interface\x7fCategory: graphics\x7fModuleInfo: Module: point InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules point postFileIn

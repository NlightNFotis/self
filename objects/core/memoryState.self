...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         memoryState = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'memoryState' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'memoryState' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules memoryState.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'memoryState' -> () From: ( | {
...
'.
 ...
 globals loadedModules memoryState postFileIn

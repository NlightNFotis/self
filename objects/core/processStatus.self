...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         processStatus = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'processStatus' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'processStatus' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules processStatus.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'processStatus' -> () From: ( | {
...
\x7fIsComplete: '.
 ...
 globals loadedModules processStatus postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         rootTraits = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'rootTraits' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'rootTraits' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules rootTraits.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'rootTraits' -> () From: ( | {
...
'.
 ...
 globals loadedModules rootTraits postFileIn

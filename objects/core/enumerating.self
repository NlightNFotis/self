...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         enumerating = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'enumerating' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'enumerating' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules enumerating.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'enumerating' -> () From: ( | {
         'ModuleInfo: Module: enumerating InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules enumerating postFileIn

...
["preFileIn" self] value
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         metaCollections = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'metaCollections' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'metaCollections' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules metaCollections.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'metaCollections' -> () From: ( | {
...
'.
 ...
 globals loadedModules metaCollections postFileIn

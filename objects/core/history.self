...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> () From: ( | {
         ...
         history = bootstrap define: bootstrap stub -> 'globals' -> 'loadedModules' -> 'history' -> () ToBe: bootstrap addSlotsTo: (
             ...
             globals loadedModules init copy ) From: bootstrap setObjectAnnotationOf: bootstrap stub -> 'globals' -> 'loadedModules' -> 'history' -> () From: ( |
             {} = 'ModuleInfo: Creator: globals loadedModules history.
...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'loadedModules' -> 'history' -> () From: ( | {
         'ModuleInfo: Module: history InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 globals loadedModules history postFileIn
